...
def list_products():
    ...
    THis endpoint will return all the products in the database
    """
...
def get_products(product_id: int):
    """
    GET a product by Id
    This endpoint will retrieve a product based on the product id passed in the route
    """
...
def update_products(product_id):
    ...
    This endpoint will update an existing product based on the body that is posted
    """
...
def delete_product(product_id):
    ...
    This endpoint will delete an existing product with the id specified
    """
