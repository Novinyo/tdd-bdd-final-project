...
class TestProductRoutes(TestCase):
    ...
    def test_get_a_product(self):
        """It should get a single a product"""
    ...
    def test_get_product_list(self):
        """It should Get aa list of products"""
    ...
    def test_query_by_name(self):
        ...
        name_count = len([prod for prod in products if prod.name == test_name])
        response = self.client.get(
    ...
    def test_query_by_availability(self):
        ...
        products = self._create_products(10)
        available_products = [prod for prod in products if prod.available]
